...
_G.packer_plugins = {
  ...
  ["mini.nvim"] = {
    loaded = true,
    path = "/Users/apokhodun/.local/share/nvim/site/pack/packer/start/mini.nvim",
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/Users/apokhodun/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  ["vim-visual-multi"] = {
    loaded = true,
    path = "/Users/apokhodun/.local/share/nvim/site/pack/packer/start/vim-visual-multi",
